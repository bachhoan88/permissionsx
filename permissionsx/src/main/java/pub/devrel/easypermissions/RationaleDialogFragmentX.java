...
public class RationaleDialogFragmentX extends AppCompatDialogFragment {
    ...
    public static RationaleDialogFragmentX newInstance(
        ...
        // Create new Fragment
        RationaleDialogFragmentX dialogFragment = new RationaleDialogFragmentX();
